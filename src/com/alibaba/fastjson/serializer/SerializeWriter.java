...
public final class SerializeWriter extends Writer {
    ...
    public void quote(String string, char sep, char seperator) {
    ...
    private void writeStringWithDoubleQuote(String text, final char seperator, boolean checkSpecial) {
        ...
        int appendLen = (int)(text.length() * 1.2);
        int newcount = (count + appendLen);
        //System.out.println("start write str");
        if (newcount > buf.length) {
            expandCapacity(newcount);
        }
        quote(text, '\"', seperator);
