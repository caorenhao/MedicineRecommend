...
import com.witspring.util.ConfigException;
...
public class ConfSelector {
	...
	public static String CONF_SELECT;
	...
	private ConfSelector() throws Exception {
		confRootDir = new File(ProcessCtr.getLocalFIndexRoot(), "conf");
	...
	private void loadSelectorFile() throws Exception {
		if(CONF_SELECT !=  null) {
			LOGGER.info("GlobalVars.confSelect is not null (" + CONF_SELECT + 
	...
	public File getConfRootDir() throws Exception {
		return new File(new File(ProcessCtr.getLocalFIndexRoot(), 
				"conf"), getConfSelect());
	}
}
